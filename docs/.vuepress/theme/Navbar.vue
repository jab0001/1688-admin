  ...
  >
    ...
    <ul class="navbar-nav flex-row mr-auto ml-4 d-none d-md-flex">
      ...
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://vue-argon-dashboard-pro-laravel.creative-tim.com"
          target="_blank"
          >Live Preview</a
        >
      </li>
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://github.com/creativetimofficial/ct-vue-argon-dashboard-pro-laravel/issues"
          target="_blank"
          >Support</a
        >
      </li>
...
<script>
import SearchBox from "../../node_modules/@vuepress/plugin-search/SearchBox.vue";
